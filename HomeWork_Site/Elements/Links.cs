...
{
    class Links : WebElements, IClickable
    {
        public string Click { get; set; }

        public Links(string webElementName, Point webPoint, int webHight, int webWidth, string click) : base(webElementName, webPoint, webHight, webWidth)
        {
            Click = click;
        }
